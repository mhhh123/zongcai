...
<main>
	...
	<section class="beijing ceo-background-contain ceo-background-top-center ceo-background-norepeat" <?php if(_ceo('single_picture') == true): ?> style="background-image: url(<?php echo _ceo('single_picture_img'); ?>);"<?php endif; ?>>
	    <?php get_template_part( 'template-parts/single/shop/ceo', 'shop4' ); ?>
		<div class="ceo-shop4-nr ceo-container ceo-margin-medium-bottom">
		<div class="ceo-display-none">
	    ...
	    <?php } ?>
		    <div class="single-main">
				<div class="ceo-container">
					<div class="b-a single-warp ceo-background-default ceo-margin-bottom ceo-padding-remove-bottom">
					    <?php if(_ceo('ceoshop_4_content_top') == true): ?>
					    <?php if (CeoShopCoreProduct::isProduct($post_id)) { ?>
                            <ul class="single-navs single-nav ceo-padding-remove-left ceo-flex">
                                ...
                                <li class="ceo-display-inline-block ceo-margin-medium-right"><span class="current"><a href="#shuxing"  ceo-scroll>信息属性</span></a></li>
                                <?php }?>

                                <li class="ceo-display-inline-block ceo-margin-medium-right"><span class=""><a href="#xiangqing"  ceo-scroll>详情介绍</a></span></li>
                                ...
                                <li class="ceo-display-inline-block ceo-margin-medium-right"><span class=""><a href="#ceoxiangguan"  ceo-scroll><?php echo _ceo('single_article_title'); ?></span></a></li>
                                <?php endif; ?>
    							...
    							<li class="ceo-display-inline-block consulting"><a href="https://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo get_the_author_meta('qq',$user_id); ?>&amp;site=qq&amp;menu=yes" target="_blank">立即咨询</a></li>
						    </ul>
						<?php } ?>
						<?php endif; ?>
                        ...
                        <?php if(_ceo('ceoshop_4_content_xq') == true): ?>
                        <?php if (CeoShopCoreProduct::isProduct($post_id)) {
