...
$pageSize = 10;
$result = CeoShopMemberProperty::getIntegralList($userId, $page, $pageSize);
...
<div class="member-property">
    ...
    <div class="bottom ceo-background-default">
        <div class="title">
            ...
            <a href="/member/integral" class="current">积分记录</a>
                ...
                <div class="box">
                    ...
                    <ul class="list">
                        <?php foreach ($result['data'] as $row) : ?>
                            <li>
                                <div class="list-1"><?php echo CeoShopCoreUser::INTEGRAL_TYPE[$row->type] ?></div>
                                <div class="list-2">
                                    <?php if ($row->op == 1) : ?>
