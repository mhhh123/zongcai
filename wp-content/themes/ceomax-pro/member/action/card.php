...
$pageSize = 10;
$result = CeoShopMemberCard::getCardList($userId, $type, $page, $pageSize);
...
<div class="member-card">
    ...
    <div class="bottom ceo-background-default">
        <div class="title">
            <a href="/member/card" class="current">代金券</a>
            <a href="/member/vipcard">VIP优惠券</a>
        </div>
                                    ...
                                    <div class="ceo-grid-ceosmls" ceo-grid>
                                        ...
                                        <div class="ceo-width-2-3">
                                            <div class="desc">
                                                ...
                                                <p>满 <?php echo $row->condition_money ?> 可用</p>
                                                <p>有效期至：<?php echo $row->expiration_time ?></p>
                                                <p>使用范围：<?php
                                                        $allowCount = count($row->allow_types);
                                                        if ($allowCount != 0) {
                                                            foreach ($row->allow_types as $index => $type) {
                                                                echo CeoShopCoreCoupon::DISCOUNT_USE_TYPE[$type];
