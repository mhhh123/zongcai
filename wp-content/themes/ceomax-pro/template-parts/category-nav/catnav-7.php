<?php
	...
	$ceo_cat7_sz = _ceo('ceo_cat7_sz');
	$cate_background_video=get_term_meta($cat,'cate_background_video',1);
?>
...
<?php endif; ?>
<div class="cat7-bg ceo-background-cover ceo-overflow-hidden ceo-flex ceo-flex-middle ceo-flex-center">
    <video muted="" loop="" autoplay="autoplay" class="video">
        <source src="<?php echo $cate_background_video['url']; ?>" type="video/mp4">
    </video>
    <div class="cat7-bg-primary ceo-position-cover"></div>
    <div class="cat7-video-model">
    	<div class="ceo-position-center ceo-text-center ceo-light">
    	    <div class="ceo-cat7-title">
    		...
    		<?php if ( _ceo('ceo-cat7-tag') == true): ?>
    		<div class="cat7-tags-item ceo-margin-top">
    			<p class="ceo-margin-small-bottom ceo-text-small">热门标签：</p>
    			<?php wp_tag_cloud('number=10&orderby=count&order=DESC&smallest=12&largest=12&unit=px'); ?>
    		</div>
    		<?php endif; ?>
        	<div class="ceo-container">
                <div class="cat7-imgbox ceo-grid-medium" ceo-grid>
                    <?php
        			if ($ceo_cat7_sz) {
        				foreach ( $ceo_cat7_sz as $key => $value) {
        			?>
                    <div class="ceo-width-1-2 ceo-width-1-4@xl">
                        <div class="cat7-imgbox-mk">
                            <img src="<?php echo $ceo_cat7_sz[$key]['img']; ?>">
                            <a href="<?php echo $ceo_cat7_sz[$key]['link']; ?>" target="_blank">
                                <em><?php echo $ceo_cat7_sz[$key]['title']; ?></em>
                                <br>
                                <span><?php echo $ceo_cat7_sz[$key]['subtitle']; ?></span>
                            </a>
                        </div>
                    </div>
                    <?php } } ?>
...
<section class="list-nav b-b ceo-background-default ceo-catnav-1">
    ...
    <?php if ( _ceo('ceo-cat7-jgsx') == true): ?>
