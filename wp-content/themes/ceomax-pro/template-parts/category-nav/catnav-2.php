...
<?php }?>
	...
	<div class="ceo-overlay ceo-position-center ceo-text-center ceo-light">
		<h3 class="ceo-position-relative ceo-light ceo-margin-remove"><?php single_cat_title(); ?>
...
<section class="list-nav b-b ceo-background-default ceo-container ceo-catnav-2" style=" margin-top: 24px!important;">
    ...
    <?php if ( _ceo('ceo-cat2-jgsx') == true): ?>
    <div class="ceo-htt"></div>
	<div class="ceo-text-small ceo-flex ceo-flex-middle ceo-catnav-2s ceo-catnav-ck">
