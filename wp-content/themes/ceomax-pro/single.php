...
<main>
	...
	<section class="beijing ceo-background-contain ceo-background-top-center ceo-background-norepeat" <?php if(_ceo('single_picture') == true): ?> style="background-image: url(<?php echo _ceo('single_picture_img'); ?>);"<?php endif; ?>>
			...
			<div class="ceo-side-lie ceo-margin-top-20" ceo-grid>
				<div class="ceo-side-lie-z single ceo-width-auto">
					<div class="">
                    			...
                    			<div class=" ceo-container ceo-text-small ceo-single-padding">
                    				<div class="single-head">
                    					...
                    					<div class="ceo-text-small ceo-text-muted ceo-flex ceo-text-truncate ceo-overflow-auto">
                    					    ...
                    					    <?php if(_ceo('single_rq_fabu') == true): ?>
                    						...
                    						<?php if(_ceo('single_sc_num') == true): ?>
                    						...
                    						<?php if(_ceo('single_ll_liulan') == true): ?>
						...
						<?php if(_ceo('single_article_article') == true): ?>
						...
						<?php if(_ceo('single_article_c_article') == true): ?>
						...
						<?php if(_ceo('single_article_contact_article') == true): ?>
		...
		<?php if(_ceo('single_article_relevant_article') == true): ?>
