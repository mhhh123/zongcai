  ...
  class CSF_Setup {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( apply_filters( 'csf_fa4', false ) ) {
        wp_enqueue_style( 'csf-fa', 'https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.7.0', 'all' );//总裁主题
      } else {
        wp_enqueue_style( 'csf-fa5', 'https://lf6-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/all.min.css', array(), '5.15.5', 'all' );//总裁主题
        wp_enqueue_style( 'csf-fa5-v4-shims', 'https://lf26-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/v4-shims.min.css', array(), '5.15.5', 'all' );//总裁主题
      }
